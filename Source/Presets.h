...
namespace Presets
{
    void deleteCurrentPreset(CloudSeedXTAudioProcessor* processor);
    void loadPreset(CloudSeedXTAudioProcessor* processor, juce::String presetName);
    void savePreset(CloudSeedXTAudioProcessor* processor, juce::String presetName);
    std::vector<juce::String> getPresets();
    juce::String getPluginResourceDir();
    juce::String getPresetDir();

    inline void showPresetMenu(
        CloudSeedXTAudioProcessor* processor,
    ...
    inline void loadPreset(CloudSeedXTAudioProcessor* processor, juce::String presetName)
    {
